            ...
            <div class="container">
                <div class="tg-highlight">
                    <div class="good-stuff">
                        <div class="tg-sicon">
                            <img src="{{ asset('assets/imgs/arrow-up.png') }}">
                        </div>
                        <div class="tg-gs-txt">
                            <h4>For</h4>

                            <p><?=$record->GoodStuff?></p>
                        </div>
                    </div>
                    <div class="bad-stuff">
                        <div class="tg-sicon">
                            <img src="{{ asset('assets/imgs/arrow-down.png') }}">
                        </div>
                        <div class="tg-bs-txt">
                            <h4>Against</h4>
                            <p> <?=$record->BadStuff?></p>
        ...
        <nav class="navbar-expand-lg">
            <div class="container">
                <ul class="navbar-nav" id="reviewTabs">
                    @foreach ($tabs as $tab)
                        <li class="nav-item">
                            <a class="nav-link {{ $selectedTab && $selectedTab->TabID == $tab->TabID ? 'tg-k' : '' }}"
                                href="#tab-content-{{ $tab->TabID }}" data-tab-content="{{ $tab->TabID }}">
                                {{ $tab->Name }}
                            </a>
                        </li>
                    @endforeach
            ...
            <div class="row">
                <div class="col-md-8">
                    @foreach ($tabContents as $content)
                        <div class="tab-content" id="tab-content-{{ $content->TabID }}"
                            style="{{ $content->TabID == $selectedTab->TabID ? '' : 'display: none;' }}">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="wrap-ad sticky-top">
                            <a href="https://www.exhibitstore.in/" target="_blank">
                                <img src="https://www.topgearmag.in/uploads/Banners/tgissue-jan2026.jpg" width="100%"
                                    alt="TopGear Magazine January 2026" />
                            </a>
                        </div>
                    </div>
                </div>
