...
<div class="kjbar-wrap">
    ...
    <div class="kjleft">
      <div class="kjcar active"><a href="#">Vote For Cars <i class="fa fa-car" aria-hidden="true"></i></a></div>
      <div class="kjbike"><a href="/voting-bikes">Vote For Bikes <i class="fa fa-motorcycle" aria-hidden="true"></i></a></div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj79" name="cat16" value="Volvo EX40 Recharge" />      
            <label for="kj79"><img src="uploads/awards25/cars/Volvo-XC40-Recharge.jpg" alt="Volvo EX40 Recharge"/>
            <p>Volvo EX40</p>
            </label>
    </div>
    </div>    
