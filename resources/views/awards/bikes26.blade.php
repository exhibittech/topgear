<!-- resources/views/awards/bikes26.blade.php -->
@extends('layouts.apphome')
<link rel="stylesheet" href="{{('assets/css/awards.css') }}">

@section('title', 'TopGear Awards 2026')
...
<!-- <div class="kjbar-wrap">
	...
	<div class="kjleft">
                <div class="kjcar "><a href="{{ route('voting26') }}">Vote For Cars <i class="fa fa-car" aria-hidden="true"></i></a></div>
...
<div class="tg-voting-wrap">
    ...
    @else -->
        ...
        <form id="tga-bike26" method="POST" action="{{ route('awards.bikes.store') }}" novalidate>
                @csrf
<!-- bcat1 -->
    <div class="row">
...
<!-- <script>
        document.getElementById('tga-bike26').addEventListener('submit', function (event) {
