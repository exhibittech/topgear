...
<div class="kjbar-wrap">
	...
	<div class="kjleft">
	<div class="kjcar"><a href="/voting">Vote For Cars <i class="fa fa-car" aria-hidden="true"></i></a></div>
	<div class="kjbike active"><a href="#">Vote For Bikes <i class="fa fa-motorcycle" aria-hidden="true"></i></a></div>
	</div>
</div>
...
<div class="row">
        ...
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj01" name="bcat1" value="Hero Xtreme 125R" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj02" name="bcat1" value="Bajaj Freedom 125" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj03" name="bcat1" value="Royal Enfield Guerrilla 450" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj04" name="bcat1" value="Bajaj Pulsar N125" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj05" name="bcat1" value="Hero Mavrick 440" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj06" name="bcat1" value="Triumph Speed T4" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj07" name="bcat1" value="Bajaj Pulsar NS400Z" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj08" name="bcat1" value="Jawa 350" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj09" name="bcat1" value="BSA Goldstar" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj10" name="bcat1" value="TVS Apache RR 310" />      
...
<div class="row">
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj11" name="bcat2" value="Ducati Streetfighter V4" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj12" name="bcat2" value="Kawasaki Z900" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj13" name="bcat2" value="BMW M1000 XR" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj14" name="bcat2" value="BMW S1000 XR" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj15" name="bcat2" value="Ducati Hypermotard 950 SP" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj16" name="bcat2" value="Suzuki GSX-8R" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj17" name="bcat2" value="KTM 1390 Super Duke R" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj18" name="bcat2" value="KTM 890 Duke R" />      
...
<div class="row">
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj19" name="bcat3" value="Revolt RV400 BRZ" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj20" name="bcat3" value="Ultraviolette F77 Mach 2" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj21" name="bcat3" value="Revolt RV1+" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj22" name="bcat3" value="Oben Rorr EZ" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj23" name="bcat3" value="Srivaru Prana 2.0" />      
        ...
        <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj24" name="bcat3" value="Matter Aera" />      
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj25" name="bcat4" value="Ather 450 Apex" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj26" name="bcat4" value="Kinetic E Luna" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj27" name="bcat4" value="Ather Rizta" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj28" name="bcat4" value="Ampere Nexus" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj29" name="bcat4" value="BGauss RUV 350" />      
    ...
    <!--<div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj30" name="bcat4" value="Bajaj Chetak 3201" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj31" name="bcat4" value="BMW CE 02" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj32" name="bcat4" value="BMW CE 04" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj33" name="bcat4" value="VLF Tennis" />      
    ...
    <!--<div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj34" name="bcat4" value="Honda Activa e" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj35" name="bcat4" value="TVS iQube ST" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj36" name="bcat4" value="TVS Jupiter" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj37" name="bcat4" value="Hero Destini 125" />      
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj38" name="bcat5" value="Hero Xtreme 125R" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj39" name="bcat5" value="Hero Splendor+ XTEC 2.0" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj40" name="bcat5" value="Bajaj Freedom 125" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj41" name="bcat5" value="Bajaj Pulsar N125" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj42" name="bcat5" value="Bajaj Pulsar NS160" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj43" name="bcat5" value="Bajaj Pulsar N150" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj44" name="bcat5" value="Bajaj Pulsar N160" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj45" name="bcat5" value="Hero Xtreme 160R" />      
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj46" name="bcat6" value="Husqvarna Vitpilen 250" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj47" name="bcat6" value="Bajaj Pulsar NS200" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj48" name="bcat6" value="Bajaj Pulsar N250" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj49" name="bcat6" value="KTM 200 Duke" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj50" name="bcat6" value="KTM 250 Duke" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj51" name="bcat6" value="Kawasaki KLX 230" />      
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj52" name="bcat7" value="Jawa 350" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj53" name="bcat7" value="Jawa 42" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj54" name="bcat7" value="Royal Enfield Classic 350" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj55" name="bcat7" value="Jawa 42 FJ" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj56" name="bcat7" value="Triumph Speed T4" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj57" name="bcat7" value="Royal Enfield Goan Classic 350" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj58" name="bcat7" value="Hero Mavrick 440" />      
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj59" name="bcat8" value="TVS Apache RR 310" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj60" name="bcat8" value="Yezdi Adventure" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj61" name="bcat8" value="Bajaj Pulsar NS400Z" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj62" name="bcat8" value="Husqvarna Svartpilen 401" />      
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj63" name="bcat9" value="Royal Enfield Guerrilla 450" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj64" name="bcat9" value="Kawasaki ZX-6R" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj65" name="bcat9" value="Kawasaki Z650 RS" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj66" name="bcat9" value="Aprilia Tuareg 660" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj67" name="bcat9" value="Kawasaki Ninja ZX-4RR" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj68" name="bcat9" value="BSA Goldstar" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj69" name="bcat9" value="Triumph Daytona 660" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj70" name="bcat9" value="Royal Enfield Bear 650" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj71" name="bcat9" value="Brixton Crossfire 500X" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj72" name="bcat9" value="Brixton Crossfire 500XC" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj73" name="bcat9" value="Honda NX500" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj74" name="bcat9" value="Kawasaki Ninja 500" />      
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj75" name="bcat10" value="Suzuki V-Strom 800DE" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj76" name="bcat10" value="Ducati DesertX Rally" />      
    ...
    <!--<div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj77" name="bcat10" value="Harley Davidson Pan America 1250 Special" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj78" name="bcat10" value="Ducati Multistrada V4 RS" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj79" name="bcat10" value="BMW F 900 GS" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj80" name="bcat10" value="Triumph Tiger 1200" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj81" name="bcat10" value="KTM 1290 Super Adventure S" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj82" name="bcat10" value="KTM 890 Adventure R" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj83" name="bcat10" value="Triumph Tiger 900" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj84" name="bcat10" value="Triumph Scrambler 1200 X" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj84" name="bcat10" value="Indian Roadmaster Elite" />      
                <label for="bkj84"><img src="uploads/awards25/bikes/Indian-Roadmaster-Elite.jpg" alt="Indian Roadmaster Elite"/>
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj85" name="bcat10" value="BMW R 12" />      
    ...
    <div class="col-lg-3 col-6">
        <div class="kjchocie-wrap">
                <input type="radio" id="bkj86" name="bcat10" value="Brixton Cromwell 1200" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj87" name="bcat10" value="Brixton Cromwell 1200 X" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj88" name="bcat10" value="Ducati Hypermotard 698 Mono" />      
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="bkj89" name="bcat10" value="BMW R1300 GS" />      
