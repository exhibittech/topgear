...
<img src="https://www.topgearmag.in/uploads/awards24/awards24-bg.jpg" width="100%">
</div>
...
<!-- cat1 -->
	<div class="row">
		...
		<div class="col-lg-3 col-6">
                <div class="kjchocie-wrap">
                        <input type="radio" id="kj02" name="cat1" value="Toyota Taisor" />      
                        <label for="kj02"><img src="uploads/awards25/cars/Toyota-Kirloskar-Taisor.jpg" alt="Toyota Taisor"/>
                        <p>Toyota Taisor</p>
                        </label>
                </div>
                </div>
...
<!-- cat2 -->
	<div class="row">
                ...
                <div class="col-lg-3 col-6">
                <div class="kjchocie-wrap">
                        <input type="radio" id="kj04" name="cat2" value="Hyundai Amaze" />      
...
<!-- cat3 -->
        <div class="row">
                ...
                <div class="col-lg-3 col-6">
                <div class="kjchocie-wrap">
                        <input type="radio" id="kj11" name="cat3" value="BMW 5 Series Long Wheelbase" />      
                        <label for="kj11"><img src="uploads/awards25/cars/BMW-5-Series-Long-Wheelbase.jpg" alt="BMW 5 Series Long Wheelbase"/>
                        <p>BMW 5 Series Long Wheelbase</p>
                        </label>
                </div>
                </div>
                <div class="col-lg-3 col-6">
                <div class="kjchocie-wrap">
                        <input type="radio" id="kj12" name="cat3" value="Mercedes-Benz LWB E-Class" />      
                        <label for="kj12"><img src="uploads/awards25/cars/Mercedes-Benz-LWB-E-Class.jpg" alt="Mercedes-Benz LWB E-Class"/>
                        <p>Mercedes-Benz LWB E-Class</p>
                        </label>
                </div>
                </div>
                <div class="col-lg-3 col-6">
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj14" name="cat4" value="Mahindra XUV3XO" />      
            <label for="kj14"><img src="uploads/awards25/cars/Mahindra-XUV-3XO.jpg" alt="Mahindra XUV3XO"/>
            <p>Mahindra XUV3XO</p>
            </label>
    </div>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj18" name="cat5" value="Citroen Basalt" />      
            <label for="kj18"><img src="uploads/awards25/cars/Citroen-Basalt.jpg" alt="Citroen Basalt"/>
            <p>Citroen Basalt</p>
            </label>
    </div>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj25" name="cat6" value="Volvo XC 40 Recharge" />      
            <label for="kj25"><img src="uploads/awards25/cars/Volvo-XC40-Recharge.jpg" alt="Volvo XC 40 Recharge"/>
            <p>Volvo XC 40 Recharge</p>
            </label>
    </div>
    </div>
    <div class="col-lg-3 col-6">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj27" name="cat6" value="BMW MINI Countryman Electric" />      
            <label for="kj27"><img src="uploads/awards25/cars/BMW-MINI-Countryman-Electric.jpg" alt="BMW MINI Countryman Electric"/>
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj38" name="cat8" value="Maserati Grecale Modena" />      
            <label for="kj38"><img src="uploads/awards25/cars/Maserati-Grecale-Modena.jpg" alt="Maserati Grecale Modena"/>
            <p>Maserati Grecale Modena</p>
            </label>
    </div>
    </div>
    <div class="col-lg-3 col-6">
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj43" name="cat9" value="Kia Carnival Limousine" />      
            <label for="kj43"><img src="uploads/awards25/cars/Kia-Carnival-Limousine.jpg" alt="Kia Carnival Limousine"/>
            <p>Kia Carnival Limousine</p>
            </label>
    </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj44" name="cat10" value="Hyundai Exter CNG Duo" />      
            <label for="kj44"><img src="uploads/awards25/cars/Hyundai-Exter-CNG-Duo.jpg" alt="Hyundai Exter CNG Duo"/>
            <p>Hyundai Exter CNG Duo</p>
            </label>
    </div>
    </div>
    <div class="col-lg-3 col-6">
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj55" name="cat12" value="Nissan New Magnite" />      
            <label for="kj55"><img src="uploads/awards25/cars/Nissan-New-Magnite.jpg" alt="Nissan New Magnite"/>
            <p>Nissan New Magnite</p>
            </label>
    </div>
    </div>
    <div class="col-lg-3 col-6">
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj61" name="cat13" value="Kia Carnival Limousine" />      
            <label for="kj61"><img src="uploads/awards25/cars/Kia-Carnival-Limousine.jpg" alt="Kia Carnival Limousine"/>
            <p>Kia Carnival Limousine</p>
            </label>
    </div>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj66" name="cat14" value="Citroen Basalt" />      
            <label for="kj66"><img src="uploads/awards25/cars/Citroen-Basalt.jpg" alt="Citroen Basalt"/>
            <p>Citroen Basalt</p>
            </label>
    </div>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj79" name="cat16" value="Volvo XC 40 Recharge" />      
            <label for="kj79"><img src="uploads/awards25/cars/Volvo-XC40-Recharge.jpg" alt="Volvo XC 40 Recharge"/>
            <p>Volvo XC 40 Recharge</p>
            </label>
    </div>
    </div>    
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
             <input type="radio" id="kj80" name="cat16" value="BMW MINI Countryman Electric" />      
             <label for="kj80"><img src="uploads/awards25/cars/BMW-MINI-Countryman-Electric.jpg" alt="BMW MINI Countryman Electric"/>
             <p>BMW MINI Countryman Electric</p>
            </label>
    </div>
    </div>
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj86" name="cat18" value="BMW M 2" />      
            <label for="kj86"><img src="uploads/awards25/cars/BMW-M-2.jpg" alt="BMW M 2"/>
            <p>BMW M 2</p>
            </label>
    </div>
    </div>   
    ...
    <div class="col-lg-3 col-6">
    <div class="kjchocie-wrap">
            <input type="radio" id="kj88" name="cat18" value="Mercedes-AMG C63 S E Performance" />      
            <label for="kj88"><img src="uploads/awards25/cars/Mercedes-AMG-C63-S-E-Performance.jpg" alt="Mercedes-AMG C63 S E Performance"/>
            <p>Mercedes-AMG C63 S E Performance</p>
            </label>
    </div>
    </div>    
    <div class="col-lg-3 col-6">
