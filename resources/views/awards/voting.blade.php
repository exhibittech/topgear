                ...
                <div class="container">
                        ...
                        @if($carVote)
                                <div class="alert alert-info">
                                        ...
                                        <p>Want to review your bike votes? <a href="{{ route('awards.bikes') }}">Go to Bike Voting</a>
                                        </p>
                                </div>
                        @else
                                <form id="tga-25" method="POST" action="{{ route('awards.voting.store') }}" novalidate>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-lg-3 col-6">
                                                        <div class="kjchocie-wrap">
                                                                <input type="radio" id="kj61c" name="cat11"
                                                                        value="Porsche Macan Electric" />
                                                                <label for="kj61c"><img
                                                                                src="uploads/awards26/cars/Porsche-Macan-Electric.jpg"
                                                                                alt="Porsche Macan Electric" />
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-lg-3 col-6">
                                                        <div class="kjchocie-wrap">
                                                                <input type="radio" id="kj77" name="cat14"
                                                                        value="Mercedes-Maybach EQS Night Series" />
                                                                <label for="kj77"><img src="uploads/awards26/cars/EQS-Night-Series.jpg"
                                                ...
                                                <div class="col-lg-3 col-6">
                                                        <div class="kjchocie-wrap">
                                                                <input type="radio" id="kj78" name="cat14"
                                                                        value="Mercedes-Maybach SL Monogram" />
                                                                <label for="kj78"><img src="uploads/awards26/cars/SL-Monogram.jpg"
                                                ...
                                                <div class="col-lg-3 col-6">
                                                        <div class="kjchocie-wrap">
                                                                <input type="radio" id="kj79" name="cat14"
                                                                        value="Mercedes-Benz GLS Night Series" />
                                                                <label for="kj79"><img src="uploads/awards26/cars/GLS-Night-Series.jpg"
