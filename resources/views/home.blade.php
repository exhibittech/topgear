...
<section class="tg-reviews-latest">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="kjwrap tg-article-item">
                    ...
                    <div class="tg-txt">
                        <a class="tg-review-tag" href="{{ url($news->menu->PageLink . '/' . $news->category->Code) }}">{{ strtoupper($news->category->Name) }}</a>
                        <h2 class="tg-review-title"><a href="{{ url('news/' . $news->category->Code . '/' . $news->Code) }}">{{ substr($news->Name, 0, 65) }}...</a></h2>
                        <span class="tg-tooltip">{{ $news->Name }}</span>
                        <span class="tg-author"><a href="{{ url('author/' . $news->Author) }}">{{ $news->Author }}</a></span> -
	...
	<div class="mt-5">
            <a href="https://www.magzter.com/IN/Exhibit/BBC-TopGear-India/Automotive/2131752" target="_blank"><img alt="TopGear Magazine September 2025" src="/uploads/Banners/tgmagzter-sep2025.png" width="100%" /></a>
          </div>
    </div>
</section>
<div id="kj-roadblock">
        ...
        <div class="row">
            <div class="tgsection-title">
				...
				<a href="https://www.youtube.com/@TopGearMagIndia" target="_blank">View All Videos
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" stroke="currentColor" fill="#d61b26" stroke-width="0" width="1em" height="1em" font-size="20" data-testid="SvgGelIconChevronRight"><path d="M21.6 14.3L5.5 31h6.4l14.6-15L11.9 1H5.5l16.1 16.7v-3.4z" stroke="none"></path></svg>
				</a>
            </div>
            <div class="col-lg-4">
                <iframe class="latestVideoEmbed" kjnum='0' height="240" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <div class="col-lg-4">
                <iframe class="latestVideoEmbed" kjnum='1' height="240" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
			<div class="col-lg-4">
                <iframe class="latestVideoEmbed" kjnum='2' height="240" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
</div>
                        </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="kjwrap tg-article-item">
                    ...
                    <div class="tg-txt">
                        <a class="tg-review-tag" href="{{ url('reviews/' . $review->menu->Code . '/' . $review->category->Code) }}">{{ strtoupper($review->category->Name) }}</a>
                        <h2 class="tg-review-title"><a href="{{ url('reviews/' . $review->menu->Code . '/' . $review->category->Code . '/' . $review->Code) }}">{{ substr($review->ReviewsTitle, 0, 65) }}...</a></h2>
                        <span class="tg-tooltip">{{ $review->ReviewsTitle }}</span>
                        <span class="tg-author"><a href="{{ url('author/' . $review->Author) }}">{{ $review->Author }}</a></span> -
    ...
    <div class="container">
        <div class="tg-trending row">
            ...
            <div class="col-lg-6 kjtrending">
                ...
                <div class="">
                    <a class="tg-review-tag" href="{{ url($item->menu->PageLink . '/' . $item->category->Code) }}">{{ $item->category->Name }}</a>
                    <h2 class="tg-review-title"><a href="{{ url($item->menu->PageLink . '/' . $item->category->Code . '/' . $item->Code) }}">{{ substr(strip_tags($item->Name ?? $item->ReviewsTitle), 0, 65) }}</a></h2>
                </div>
            </div>
            @endforeach
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="kjwrap tg-article-item">
                        <div class="tg-media">
                            <a class="d-block" href="{{ url('features/' . $feature->category->Code . '/' . $feature->Code) }}">
                                <img src="{{ url($feature->ImagePath ?? $feature->ImagePath) }}" alt="{{ $altText }}">
                            </a>
                        </div>
                        <div class="tg-txt">
                            <a class="tg-review-tag" href="{{ url($feature->menu->PageLink . '/' . $feature->category->Code) }}">{{ strtoupper($feature->category->Name) }}</a>
                            <h2 class="tg-review-title"><a href="{{ url('features/' . $feature->category->Code . '/' . $feature->Code) }}">{{ substr($feature->Name, 0, 65) }}...</a></h2>
            ...
            <div class="kjnewsletter">
                <div class="tg-newsletter-wrap">
                    <div class="newsletter-header">
                        ...
                        <p>Stay up to date with all our latest content, news reports and reviews by subscribing to our newsletter! <br>PS: We don't intend to sell your data to the highest bidder...</p>
                    </div>
                      ...
                      <div class="ml-form-align-center">
                        <div class="ml-form-embedWrapper embedForm">
                          <div class="ml-form-embedBody ml-form-embedBodyDefault row-form">
                            ...
                            <form class="ml-block-form tg-newsletter" action="https://static.mailerlite.com/webforms/submit/n4j3t8" data-code="n4j3t8" method="post" target="_blank">
                              <div class="ml-form-formContent">
                                ...
                                <div class="ml-form-fieldRow ml-last-item">
                                  <div class="ml-field-group ml-field-company">
                                    ...
                                    <input aria-label="company" type="text" class="form-control" data-inputmask="" name="fields[company]" placeholder="What's in your garage" autocomplete="">
                                  </div>
                                </div>
                              </div>
