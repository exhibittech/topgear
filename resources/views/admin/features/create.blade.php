...
<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-md sm:rounded-lg p-8">
            ...
            <form action="{{ route('adminfeatures.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Name Field -->
                        <div class="space-y-2">
                            <label for="Name" class="block text-sm font-semibold text-gray-700">Feature Title</label>
                            <input type="text" name="Name" value="{{ old('Name') }}" class="block w-full px-3 py-2 border @error('Name') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" id="Name" placeholder="Enter feature title" required>
                            @error('Name')
                        ...
                        <!-- Category Field -->
                        <div class="space-y-2">
                            <label for="CategoryID" class="block text-sm font-semibold text-gray-700">Category</label>
                            <select name="CategoryID" id="CategoryID" class="block w-full pl-3 pr-10 py-2 text-base border @error('CategoryID') border-red-500 @else border-gray-300 @enderror focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            <label for="Image" class="block text-sm font-semibold text-gray-700">
                                Slider Images (Upload multiple) <span class="text-gray-500 text-sm">(1300 x 728, Max: 428KB per image)</span>
                            </label>
                            <input type="file" name="Images[]" multiple class="block w-full text-sm text-gray-900 border @error('Images.*') border-red-500 @else border-gray-300 @enderror rounded-lg cursor-pointer bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500" id="Image">
