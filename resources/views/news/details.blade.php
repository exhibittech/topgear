                    ...
                    <div class="col-md-9">
                        <div id="carousel-thumbnail" class="carousel slide article-slider" data-bs-ride="carousel">
                            ...
                            <div class="thumbnail-navigation-wrapper">
                                <button type="button" class="thumbnail-nav-btn thumbnail-nav-prev" id="thumbnailPrev" aria-label="Previous thumbnails">
                                ...
                                <button type="button" class="thumbnail-nav-btn thumbnail-nav-next" id="thumbnailNext" aria-label="Next thumbnails">
                ...
                <div class="col-md-4">
                    <div class="wrap-ad sticky-top">
                        <a href="https://www.exhibitstore.in/" target="_blank">
                            <img src="https://www.topgearmag.in/uploads/Banners/tgissue-feb2026.jpg" width="100%"
                                alt="TopGear Magazine February 2026" />
                        </a>
                            ...
                            @foreach($relatedArticles as $related)
                                <div class="col-md-4">
                                    <div class="tgrelated-article">
                                        <div class="tg-media">
                                            <a href="{{ url('news/' . $related->category->Code . '/' . $related->Code) }}">
