...
<head>
    ...
    <!-- Preload Fonts -->
    <link rel="preload" href="{{ asset('assets/css/fonts/industry_tg_bold.otf') }}" as="font" type="font/otf"
        crossorigin>
    <link rel="preload" href="{{ asset('assets/css/fonts/industry_tg_book.otf') }}" as="font" type="font/otf"
        crossorigin>
    <link rel="preload" href="{{ asset('assets/css/fonts/industry_tg_ultra.otf') }}" as="font" type="font/otf"
        crossorigin>
