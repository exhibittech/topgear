    ...
    <div class="hero-slider carousel slide pointer-event" data-bs-ride="carousel" id="carouselExampleIndicators">
        <div class="carousel-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <a href="{{ url($item->menu->PageLink . '/' . $item->category->Code . '/' . $item->Code) }}">
                                <img alt="{{ $altText }}" class="w-100" src="{{ url($item->ImagePath ?? $item->ImagePath) }}">
                            </a>
                        </div>
                        <div class="col-lg-4">
                            <div class="caption">
                                <a href="{{ url($item->menu->PageLink . '/' . $item->category->Code) }}" class="tgnews-tag">{{ strtoupper($item->category->Name) }}</a>
                                ...
                                <p><a href="{{ url($item->menu->PageLink . '/' . $item->category->Code . '/' . $item->Code) }}">Learn More</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="carousel-item">
                <img alt="TopGear India Magazine September 2025" class="d-block w-100" src="https://www.topgearmag.in/uploads/Banners/tgbanner-sep2025.png">
