                    ...
                    <tr>
                        <td align="center" style="padding:36px 40px 24px;background-color:#111111;">
                            <img src="https://topgearmag.in/uploads/Banners/redlineclub.jpg"
                                alt="TopGear India Red Line Club" width="560"
                    ...
                    <tr>
                        <td style="padding:32px 40px 24px;">
                            ...
                            <p style="margin:0 0 16px;font-size:16px;color:#cccccc;line-height:1.7;">
                                You're officially in. Welcome to the <strong style="color:#e21b22;">Red Line
                                    Club</strong> — TopGear India's exclusive community for India's most passionate
                                drivers.
                            </p>

                            <p style="margin:0 0 16px;font-size:16px;color:#cccccc;line-height:1.7;">
                                Your registration and payment of <strong style="color:#ffffff;">INR 30,000</strong> have
                                been confirmed. Your spot is secured for <strong style="color:#ffffff;">1 Car & 2
                                    Pax</strong> at the inaugural event.
                            </p>
                                ...
                                <tr>
                                    <td style="padding:20px 24px;">
                                        <p
                                            ...
                                            Event Details</p>
                                        <p style="margin:0 0 10px;font-size:20px;font-weight:700;color:#ffffff;">
                                            Founder's Edition — Red Line Club</p>
                                        <p style="margin:0 0 6px;font-size:15px;color:#cccccc;">📅 &nbsp;June 07, 2026
                                        </p>
                                        <p style="margin:0 0 6px;font-size:15px;color:#cccccc;">📍 &nbsp;Aamby Valley
                                            Airstrip, Maharashtra</p>
                                        <p style="margin:0;font-size:15px;color:#cccccc;">🚗 &nbsp;1 Car & 2 Pax (Invite
                                            Only)</p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td style="padding:20px 24px;">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding:4px 0;font-size:14px;color:#888888;width:120px;">
                                                    Brand</td>
                            ...
                            <p style="margin:0 0 16px;font-size:16px;color:#cccccc;line-height:1.7;">
                                More details about the event — including the schedule, parking, and run format — will
                                follow closer to the date. Keep an eye on your inbox.
                            </p>
